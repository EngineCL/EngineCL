...
namespace Catch {
    ...
    struct SourceLineInfo {
         ...
         *
         * @param
         * @return SourceLineInfo &&operator
         */
        ...
        char const* file; /**< TODO: describe */
        std::size_t line; /**< TODO: describe */
    };
...
namespace Catch {
    ...
    struct ITestCaseRegistry {
         ...
         * @brief
         *
         * @return const std::vector<TestCase>
         */
...
namespace Catch {
    ...
    class StringRef {
        ...
        char const* m_start; /**< TODO: describe */
        size_type m_size; /**< TODO: describe */

        char* m_data = nullptr; /**< TODO: describe */
...
struct NameAndTags {
    ...
    StringRef name; /**< TODO: describe */
    StringRef tags; /**< TODO: describe */
};
 ...
 *
 * @param
 * @param Catch_global_namespace_dummy
 * @return std::ostream &operator
 */
...
namespace Catch {
    ...
    namespace Detail {
        ...
        extern const std::string unprintableString; /**< TODO: describe */
        ...
        public:
            static const bool value = decltype(test<std::ostream, const T&>(0))::value; /**< TODO: describe */
        };
    ...
    struct StringMaker {
        ...
        typename std::enable_if<::Catch::Detail::IsStreamInsertable<Fake>::value, std::string>::type
             ...
             *
             * @param t
             * @return std::enable_if<::Catch::Detail::IsStreamInsertable<Fake>::value, std::string>
             */
        ...
        typename std::enable_if<!::Catch::Detail::IsStreamInsertable<Fake>::value, std::string>::type
             ...
             *
             * @param
             * @return std::enable_if<_Tp1, std::string>
             */
            convert(const Fake&) {
...
namespace Catch {
    ...
    class BinaryExpr  : public ITransientExpression {
        bool m_result; /**< TODO: describe */
        LhsT m_lhs; /**< TODO: describe */
        StringRef m_op; /**< TODO: describe */
        RhsT m_rhs; /**< TODO: describe */
    ...
    public:
         ...
         *
         * @param rhs
         * @return const BinaryExpr<LhsT, const RhsT &>
         */
         ...
         *
         * @param rhs
         * @return const BinaryExpr<LhsT, bool>
         */
         ...
         *
         * @param rhs
         * @return const BinaryExpr<LhsT, const RhsT &> operator >
         */
        auto operator > ( RhsT const& rhs ) -> BinaryExpr<LhsT, RhsT const&> const {
...
namespace Catch {
     ...
     * @param lhs
     * @param rhs
     * @return ResultDisposition::Flags operator
     */
...
namespace Catch {
    ...
    {
        StringRef macroName; /**< TODO: describe */
        SourceLineInfo lineInfo; /**< TODO: describe */
        StringRef capturedExpression; /**< TODO: describe */
        ResultDisposition::Flags resultDisposition; /**< TODO: describe */
...
namespace Catch {
    ...
    class LazyExpression {
        ...
        ITransientExpression const* m_transientExpression = nullptr; /**< TODO: describe */
        bool m_isNegated; /**< TODO: describe */
    public:
        /**
         * @brief
         *
         ...
         *
         * @param
         * @return LazyExpression &operator
         */
    ...
    class AssertionHandler {
        AssertionInfo m_assertionInfo; /**< TODO: describe */
        bool m_shouldDebugBreak = false; /**< TODO: describe */
        bool m_shouldThrow = false; /**< TODO: describe */
        bool m_inExceptionGuard = false; /**< TODO: describe */
    ...
    public:
         ...
         * @param macroName
         * @param lineInfo
         * @param capturedExpression
         * @param resultDisposition
         */
        AssertionHandler
            (   StringRef macroName,
...
namespace Catch {
    ...
    struct MessageInfo {
        ...
        std::string macroName; /**< TODO: describe */
        std::string message; /**< TODO: describe */
        SourceLineInfo lineInfo; /**< TODO: describe */
        ResultWas::OfType type; /**< TODO: describe */
        unsigned int sequence; /**< TODO: describe */
        ...
        bool operator < ( MessageInfo const& other ) const;
    private:
        static unsigned int globalCount; /**< TODO: describe */
    };
    ...
    struct MessageStream {
        ...
        std::ostringstream m_stream; /**< TODO: describe */
    };
    ...
    struct MessageBuilder : MessageStream {
         ...
         *
         * @param value
         * @return MessageBuilder &operator
         */
        ...
        MessageInfo m_info; /**< TODO: describe */
    };
...
namespace Catch {
    ...
    struct Counts {
        ...
        std::size_t passed = 0; /**< TODO: describe */
        std::size_t failed = 0; /**< TODO: describe */
        std::size_t failedButOk = 0; /**< TODO: describe */
    };
    ...
    struct Totals {
        ...
        Counts assertions; /**< TODO: describe */
        Counts testCases; /**< TODO: describe */
    };
}
...
namespace Catch {
    ...
    struct SectionInfo {
        ...
        std::string description; /**< TODO: describe */
        SourceLineInfo lineInfo; /**< TODO: describe */
    };
    ...
    struct SectionEndInfo {
         ...
         *
         * @param _sectionInfo
         * @param _prevAssertions
         * @param _durationInSeconds
         */
        SectionEndInfo( SectionInfo const& _sectionInfo, Counts const& _prevAssertions, double _durationInSeconds );

        SectionInfo sectionInfo; /**< TODO: describe */
        Counts prevAssertions; /**< TODO: describe */
        double durationInSeconds; /**< TODO: describe */
    };
...
namespace Catch {
     ...
     */
    class Timer {
        uint64_t m_nanoseconds = 0; /**< TODO: describe */
    public:
        /**
         * @brief
         *
...
namespace Catch {
    ...
    private:
        SectionInfo m_info; /**< TODO: describe */

        std::string m_name; /**< TODO: describe */
        Counts m_assertions; /**< TODO: describe */
        bool m_sectionIncluded; /**< TODO: describe */
        Timer m_timer; /**< TODO: describe */
    };
...
namespace Catch {
    ...
    class BenchmarkLooper {
        ...
        std::string m_name; /**< TODO: describe */
        std::size_t m_count = 0; /**< TODO: describe */
        std::size_t m_iterationsToRun = 1; /**< TODO: describe */
        uint64_t m_resolution; /**< TODO: describe */
        Timer m_timer; /**< TODO: describe */
...
namespace Catch {
    ...
    struct IRegistryHub {
         ...
         * @brief
         *
         * @return const IReporterRegistry
         */
        virtual IReporterRegistry const& getReporterRegistry() const = 0;
        /**
         * @brief
         *
         * @return const ITestCaseRegistry
         */
        virtual ITestCaseRegistry const& getTestCaseRegistry() const = 0;
        /**
         * @brief
         *
         * @return const ITagAliasRegistry
         */
         ...
         * @brief
         *
         * @return IExceptionTranslatorRegistry
         */
         ...
         * @brief
         *
         * @return const StartupExceptionRegistry
         */
...
namespace Detail {
    ...
    private:
        double m_epsilon; /**< TODO: describe */
        double m_margin; /**< TODO: describe */
        double m_scale; /**< TODO: describe */
        double m_value; /**< TODO: describe */
    };
}
...
namespace Catch {
    ...
    struct pluralise {
        ...
        std::size_t m_count; /**< TODO: describe */
        std::string m_label; /**< TODO: describe */
    };
}
...
namespace Matchers {
    namespace Impl {
        ...
        public:
             ...
             *
             * @param
             * @return MatcherUntypedBase &operator
             */
        ...
        protected:
            ...
            mutable std::string m_cachedToString; /**< TODO: describe */
        };
        ...
        struct MatcherBase : MatcherUntypedBase, MatcherMethod<ObjectT> {
             ...
             *
             * @param other
             * @return MatchAnyOf<ComparatorT>
             */
            MatchAnyOf<ComparatorT> operator || ( MatcherBase const& other ) const;
            /**
             * @brief
             *
             * @return MatchNotOf<ComparatorT>
             */
        ...
        struct MatchAllOf : MatcherBase<ArgT> {
            ...
            std::vector<MatcherBase<ArgT> const*> m_matchers; /**< TODO: describe */
        };
        template<typename ArgT>
        /**
         * @brief
        ...
        struct MatchNotOf : MatcherBase<ArgT> {
            ...
            MatcherBase<ArgT> const& m_underlyingMatcher; /**< TODO: describe */
        };
         ...
         *
         * @param other
         * @return MatchAllOf<ComparatorT> MatcherBase<ObjectT, ComparatorT>
         */
         ...
         *
         * @param other
         * @return MatchAnyOf<ComparatorT> MatcherBase<ObjectT, ComparatorT>
         */
         ...
         * @brief
         *
         * @return MatchNotOf<ComparatorT> MatcherBase<ObjectT, ComparatorT>
         */
...
namespace Matchers {
    ...
    namespace StdString {
        ...
        struct CasedString
        {
            ...
            CaseSensitive::Choice m_caseSensitivity; /**< TODO: describe */
            std::string m_str; /**< TODO: describe */
        };
        ...
        struct StringMatcherBase : MatcherBase<std::string> {
            ...
            CasedString m_comparator; /**< TODO: describe */
            std::string m_operation; /**< TODO: describe */
        };
...
namespace Matchers {
    ...
    namespace Vector {
        ...
        struct ContainsElementMatcher : MatcherBase<std::vector<T>, T> {
            ...
            T const& m_comparator; /**< TODO: describe */
        };
        ...
        struct ContainsMatcher : MatcherBase<std::vector<T>, std::vector<T> > {
            ...
            std::vector<T> const& m_comparator; /**< TODO: describe */
        };
...
namespace Catch {
    ...
    class MatchExpr : public ITransientExpression {
        ArgT const& m_arg; /**< TODO: describe */
        MatcherT m_matcher; /**< TODO: describe */
        StringRef m_matcherString; /**< TODO: describe */
        bool m_result; /**< TODO: describe */
    public:
        /**
         * @brief
...
namespace Catch {
    ...
    struct TestCaseInfo {
        ...
        std::string name; /**< TODO: describe */
        std::string className; /**< TODO: describe */
        std::string description; /**< TODO: describe */
        std::vector<std::string> tags; /**< TODO: describe */
        std::vector<std::string> lcaseTags; /**< TODO: describe */
        SourceLineInfo lineInfo; /**< TODO: describe */
        SpecialProperties properties; /**< TODO: describe */
    };
    ...
    private:
        std::shared_ptr<ITestInvoker> test; /**< TODO: describe */
    };
